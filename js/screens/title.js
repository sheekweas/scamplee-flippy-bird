    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                ...
                this.text = me.device.touch ? 'Бастау үшін экранды басасың' : 'SPACE дегенді либо сол жақ мышкамен басасың бастау үшін \n\t\t\t\t\t\t\t\t\t\t\t Музыка задолбалынды шығарса, "M" деген кнопканы баса сал!';
